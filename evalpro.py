...
def main(cfg: DictConfig):
    ...
    index_dir = os.path.join(root_dir, f"{corpus_tag}_bm25_optimized_index")
    ...
    print(f"🛠️ 模式: {cfg.experiment.mode} | 源: {cfg.model.source} | 数据集: {cfg.experiment.test_dataset_name}")
